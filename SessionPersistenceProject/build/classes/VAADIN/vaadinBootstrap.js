(function() {
	...
	window.vaadin = window.vaadin || {
		...
		getBrowserDetailsParameters: function(parentElementId) {
			...
			try{
				if(('localStorage' in window && window['localStorage'] !== null)==true){//Check for localStorage support
					url += "&v-session=" + localStorage.getItem('v-session'); // Add the session-data to header
				} else{
